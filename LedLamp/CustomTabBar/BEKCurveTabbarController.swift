...
public class BEKCurveTabbarController: UITabBarController {
    ...
    {
        let controller = UIStoryboard(name: "CustomTabBar", bundle: Bundle(for: BEKCurveTabbarController.self)).instantiateViewController(withIdentifier: "BEKCurveTabbarController") as! BEKCurveTabbarController
