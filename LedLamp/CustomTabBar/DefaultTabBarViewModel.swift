...
public struct DefaultTabBarViewModel: BEKTabBarViewModelType {
    ...
    public let selectedTextColor: UIColor = .black //UIColor(red: 231/255, green: 231/255, blue: 231/255, alpha: 1)
    public let selectedTextFont: UIFont = .systemFont(ofSize: 13)
    public let normalTextColor: UIColor = .green//UIColor(red: 231/255, green: 231/255, blue: 231/255, alpha: 1)
