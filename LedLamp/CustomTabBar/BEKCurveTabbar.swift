...
public class BEKCurveTabbar: UITabBar {
    ...
    override public func layoutIfNeeded() {
        ...
        frame = CGRect(origin: self.frame.origin, size: .init(width: self.frame.width, height: 80))
        ...
        appearance.stackedLayoutAppearance.normal.titleTextAttributes = [NSAttributedString.Key.font: selectedFont,NSAttributedString.Key.foregroundColor: textColor]
        appearance.stackedLayoutAppearance.normal.iconColor = textColor
